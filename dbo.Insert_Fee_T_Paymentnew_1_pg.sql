CREATE OR REPLACE FUNCTION "dbo"."Insert_Fee_T_Paymentnew_1"(
    "listparam" TEXT,
    "mi_id" VARCHAR(10),
    "asmay_id" BIGINT,
    "amst_id" BIGINT,
...
BEGIN
    ...
    SELECT 'temp' || CAST(FLOOR((998+1)*RANDOM())::INTEGER AS VARCHAR) INTO "tablenme";
    ...
    FOR "rec" IN EXECUTE 'SELECT "FYP_Id", "FMA_Id", "FTP_Paid_Amt", "FTP_Fine_Amt", "FTP_Concession_Amt", "FTP_Waived_Amt" 
                          FROM ' || "tablenme" || ' WHERE "MI_Id" = ' || "mi_id"
    LOOP
        "FYP_Id" := "rec"."FYP_Id";
        "FMA_Id" := "rec"."FMA_Id";
