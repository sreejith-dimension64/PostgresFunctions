CREATE OR REPLACE FUNCTION "dbo"."EmployeeSalaryGenerationMethodThree_bkpHRAnew"(
    p_HRME_ID BIGINT,
    p_MI_ID BIGINT,
    p_HRMLY_ID BIGINT,
...
DECLARE
    ...
    v_HRMED_IdCUR1 BIGINT; v_TEMPSALCOUNT INT; v_HRMED_IdCUR3 BIGINT; v_HRMEDP_HRMED_IdCUR2 BIGINT; v_HRMEDP_HRMED_IdCUR3 BIGINT; v_CUR3HEADCOUNT INT; v_HREED_ApplicableMaxValueCUR DECIMAL(18,2);
    ...
    v_HRC_ARTFPFPer DECIMAL(18,2); v_HRC_ARTEPFPer DECIMAL(18,2); v_HRC_RetirementYrs BIGINT;
    v_HRAGEMM_Year BIGINT; v_HRAGEMM BIGINT;
    v_AgeToDate VARCHAR(10); v_AgeToDate_New DATE; v_IVRM_Month_Max_Days INT; v_MonthId INT;
...
BEGIN
    ...
    ELSE
        v_MONTH_START_DATE := CONCAT(v_LEAVE_YEAR, '-', v_MONTH, '-', v_DAYFROM);
        v_DAYTO := dbo."DaysInMonth"(v_LEAVE_YEAR, v_MONTH);
    ...
    LOOP
        v_HRMED_IdCUR1 := rec1."HRMED_Id";
        v_HREED_AmountCUR1 := rec1."HREED_Amount";
        v_HRMED_EDTypeFlagCUR1 := rec1."HRMED_EDTypeFlag";
        v_HRMED_EarnDedFlagCUR1 := rec1."HRMED_EarnDedFlag";
        v_HRMED_AmountPercentFlagCUR1 := rec1."HRMED_AmountPercentFlag";
        v_HRMED_RoundOffFlagCUR1 := rec1."HRMED_RoundOffFlag";
    ...
    FOR rec2 IN
        ...
        WHERE A."MI_Id" = p_MI_ID AND B."HRME_Id" = p_HRME_ID AND B