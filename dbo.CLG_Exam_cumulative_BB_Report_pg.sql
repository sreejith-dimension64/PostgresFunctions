CREATE OR REPLACE FUNCTION "dbo"."CLG_Exam_cumulative_BB_Report"(
    p_AMCO_Id bigint,
    p_AMB_Id bigint,
    p_ACSS_Id bigint,
    p_MI_Id bigint,
...
RETURNS TABLE(
    ...
    "ECSTMP_SemRank" bigint,
    "ECSTMP_SectionRank" bigint,
...
BEGIN
    ...
    SELECT DISTINCT 
        ...
        "AMCS"."AMCST_FirstName" AS "AMST_FirstName",
        "AMCS"."AMCST_MiddleName" AS "AMST_MiddleName",
        "AMCS"."AMCST_LastName" AS "AMST_LastName",
        "AMCS"."AMCST_DOB" AS "AMST_DOB",
        "ACYS"."ACYST_RollNo" AS "AMAY_RollNo",
        "AMCS"."AMCST_AdmNo" AS "AMST_AdmNo",
        "CEYCES"."ISMS_Id",
        ...
        COALESCE((SELECT sum("ACSA"."ACSA_ClassHeld") 
                  ...
                  AND "ACSA"."ACSA_AttendanceDate"::date BETWEEN "CEYCE"."ECYSE_AttendanceFromDate" AND "CEYCE"."ECYSE_AttendanceToDate"), 0) AS "ASA_ClassHeld",
        COALESCE((SELECT sum("ACSAS"."ACSAS_ClassAttended") 
                  ...
                  AND "ACSA"."ACSA_AttendanceDate"::date BETWEEN "CEYCE"."ECYSE_AttendanceFromDate" AND "CEYCE"."ECYSE_AttendanceToDate"), 0) AS "ASA_Class_Attended",
        "EMGD1"."EMGD_Remarks",
    ...
    LEFT OUTER JOIN "CLG"."Exm_Col_Student_Marks_Process_Subjectwise" AS "ECSMPS" ON "ECSMPS"."ISMS_Id" = "CEYCES"."ISMS_Id" 
        ...
        AND "ECSMPS"."ASMAY_Id" = v_ASMAY_Id 
    ...
    INNER JOIN "CLG"."Exm_Col_Studentwise_Subjects" AS "ECSS" ON "ECSS"."ISMS_Id" = "ECSMPS"."ISMS_Id" 
        ...
        AND "ECSS"."ASMAY_Id" = v_ASMAY_Id 
        AND "ECSS"."AMCO_Id" = p_AMCO_Id 
        AND "ECSS"."AMB_Id" = p_AMB_Id 
        AND "ECSS"."AMSE_Id" = p_AMSE_Id 
        AND "ECSS"."AMSE_Id" = p_AMSE_Id 
        AND "ECSS"."ACMS_Id" = p_ACMS_Id
    GROUP BY "AMCS"."AMCST_Id", "AMCS"."AMCST_FirstName", "AMCS"."AMCST_MiddleName", "AMCS"."AMCST_LastName", 
        "AMCS"."AMCST_DOB", "ACYS"."ACYST_RollNo", "AMCS"."AMCST_AdmNo", "CEYCES"."ISMS_Id", "IMS"."ISMS_SubjectName", 
        "IMS"."ISMS_SubjectCode", "CEYCES"."ECYSES_AplResultFlg", "CEYCES"."ECYSES_MaxMarks", "CEYCES"."ECYSES_MinMarks", 
        "CEYCES"."EMGR_Id", "ECSMPS"."ECSTMPS_MaxMarks", "ECSMPS"."ECSTMPS_SemAverage", "ECSMPS"."ECSTMPS_SectionAverage", 
        "ECSMPS"."ECSTMPS_SemHighest", "ECSMPS"."ECSTMPS_SectionHighest", "ECSMPS"."ECSTMPS_ObtainedMarks", 
        "ECSMPS"."ECSTMPS_ObtainedGrade", "ECSMPS"."ECSTMPS_PassFailFlg", "EME"."EME_ExamName", "AMC"."AMCO_CourseName", 
        "AMB_BranchName", "AMSE_SEMName", "ACMS_SectionName", "EMGD1"."EMGD_Remarks", "ECSMP"."ECSTMP_TotalObtMarks", 
        "ECSTMP_TotalMaxMarks", "ECSMP"."ECSTMP_Percentage", "ECSMP"."ECSTMP_TotalGrade", "ECSMP"."ECSTMP_SemRank", 
        "ECSMP"."ECSTMP_SectionRank", "EMGD2"."EMGD_Remarks", "ECSMP"."ECSTMP_TotalObtMarks", "MI"."MI_name", 
