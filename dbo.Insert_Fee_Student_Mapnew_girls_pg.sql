CREATE OR REPLACE FUNCTION "dbo"."Insert_Fee_Student_Mapnew_girls"(
    p_fmg_id BIGINT,
    p_amst_id BIGINT,
    p_MI_ID BIGINT,
    p_fti_id_new BIGINT,
...
BEGIN
    ...
    PERFORM * FROM "Fee_Master_Student_Group" 
    ...
    IF v_rowcount = 0 THEN
        ...
        VALUES (p_MI_ID, p_amst_id, v_asmay_id, p_fmg_id, 'Y');
    END IF;
                    ...
                    LOOP
                        ...
                        IF v_rowcount = 0 THEN
                            ...
                            INSERT INTO "Fee_Student_Status"(
                                ...
                                p_MI_ID, v_asmay_id, p_amst_id, p_fmg_id, p_FMH_ID_new, p_fti_id_new, v_fma_id, 
                                0, 0, v_fma_amount, v_fma_amount, v_fma_amount, 0, 0, 0, 0, v_ftp_concession_amt, 
                                0, 0, 0, 0, 0, 0, v_fma_amount, 0, 0, 0, 1, p_userid, 0
                            );
