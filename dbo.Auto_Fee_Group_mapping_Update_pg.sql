CREATE OR REPLACE FUNCTION "dbo"."Auto_Fee_Group_mapping_Update"(
    p_MI_Id bigint,
    p_ASMAY_Id bigint,
    p_AMST_Id bigint,
    p_UserId bigint
...
BEGIN
    ...
    BEGIN
        FOR rec_yearly_fee IN
            ...
            FROM "Fee_Yearly_Group_Head_Mapping_New" "FYGHM"
            INNER JOIN "Fee_Master_Group_New" "FMG" ON "FYGHM"."FMG_Id" = "FMG"."FMG_Id"
            INNER JOIN "Fee_Master_Head_New" "FMH" ON "FMH"."FMH_Id" = "FYGHM"."FMH_Id" 
            WHERE "FYGHM"."MI_Id" = p_MI_Id 
            AND ("FMH"."FMH_Flag" = 'N' OR "FMG"."FMG_CompulsoryFlag" = 1)
        LOOP
            v_FMG_Id := rec_yearly_fee."FMG_Id";

            SELECT COUNT(*) INTO v_row_count 
            FROM "Fee_Master_Student_Group_New" 
            WHERE "FMG_Id" = v_FMG_Id 
            AND "MI_Id" = p_MI_Id 
            AND "ASMAY_Id" = p_ASMAY_Id;

            IF v_row_count = 0 THEN
                INSERT INTO "Fee_Master_Student_Group_New" 
                ...
                LOOP
                    ...
                    INSERT INTO "Fee_Master_Student_Group_Installment_new" 
                        ("FMSG_Id", "FMH_ID", "FTI_ID") 
                    VALUES 
                        (v_FMSG_Id, v_FMH_Id, v_FTI_Id);

                    INSERT INTO "Fee_Student_Status_New"(
