CREATE OR REPLACE FUNCTION "dbo"."Adm_Sourcewiseadmissioncount2"(
    p_MI_ID TEXT,
    p_ASMAY_ID TEXT
)
RETURNS TABLE (
...
BEGIN
    ...
    v_dynamic := 'SELECT "ASMAY"."ASMAY_Year", "PMR"."PAMR_ReferenceName", COALESCE(COUNT(DISTINCT "ASYS"."AMST_Id"), 0) AS "Studentcount"
    ...
    GROUP BY "ASMAY"."ASMAY_Year", "PMR"."PAMR_ReferenceName"';
