CREATE OR REPLACE FUNCTION "dbo"."Adm_Transfer_certificate_modified"(
    "yearId" TEXT,
    "classid" TEXT,
    "sectionid" TEXT,
    "studid" TEXT,
...
BEGIN
    ...
    SELECT 
        ...
        (COALESCE("Adm_M_Student"."AMST_PerStreet", '') || ',' || COALESCE("Adm_M_Student"."AMST_PerArea", '') || ',' || 
         ...
         COALESCE("IVRM_Master_Country"."IVRMMC_CountryName", '')) AS "addressd1",
    ...
    FROM 
        "dbo"."Adm_M_Student"
        LEFT OUTER JOIN "dbo"."IVRM_Master_State" ON "Adm_M_Student"."AMST_PerState" = "IVRM_Master_State"."IVRMMS_Id"
        ...
        LEFT OUTER JOIN "dbo"."IVRM_Master_Country" ON "IVRM_Master_Country"."IVRMMC_Id" = "Adm_M_Student"."AMST_PerCountry"
        LEFT OUTER JOIN "dbo"."ivrm_master_caste" ON "ivrm_master_caste"."imc_id" = "Adm_M_Student"."ic_id"
        LEFT OUTER JOIN "dbo"."IVRM_Master_Religion" ON "IVRM_Master_Religion"."IVRMMR_Id" = "Adm_M_Student"."IVRMMR_Id"
    WHERE 
        "Adm_School_Y_Student"."AMST_Id" = "studid"::BIGINT 
        AND "Adm_School_M_Academic_Year"."ASMAY_Id" = "yearId"::BIGINT 
