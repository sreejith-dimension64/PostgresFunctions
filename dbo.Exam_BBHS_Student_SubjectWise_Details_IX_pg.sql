CREATE OR REPLACE FUNCTION "dbo"."Exam_BBHS_Student_SubjectWise_Details_IX"(
    "@MI_Id" TEXT,
    "@ASMAY_Id" TEXT,
    "@ASMCL_Id" TEXT,
    "@ASMS_Id" TEXT,
...
BEGIN
    ...
    "@SQLQUERY" := 'CREATE TEMP TABLE "NDS_Temp_StudentDetails_Amstids" AS SELECT DISTINCT "AMST_Id" FROM "ADM_M_STUDENT" WHERE "AMST_Id" IN(' || "@AMST_Id" || ') AND "MI_Id" = ' || "@MI_Id";
    ...
    SELECT * FROM (
        SELECT 
            ...
            "E"."EMPSG_DisplayName",
            "E"."AMST_Id",
            SUM("E"."ObtainedMarks") AS "ObtainedMarks",
            CAST((SUM("E"."ObtainedMarks") * 100.0 / SUM("E"."EMPSGE_ForMaxMarkrs")) AS DECIMAL(18,2)) AS "TotalPercentage",
            (SELECT "EMGD_Name"
             FROM "Exm"."Exm_Master_Grade_Details" AS "L"
             WHERE ((SUM("E"."ObtainedMarks") * 100.0 / SUM("F"."ESTMPPSG_GroupMaxMarks")) BETWEEN "L"."EMGD_From" AND "L"."EMGD_To" AND "L"."EMGR_Id" = "A"."EMGR_Id")
                OR ((SUM("E"."ObtainedMarks") * 100.0 / SUM("F"."ESTMPPSG_GroupMaxMarks")) BETWEEN "L"."EMGD_To" AND "L"."EMGD_From" AND "L"."EMGR_Id" = "A"."EMGR_Id")
             LIMIT 1) AS "EMGD_Name",
            "I"."ESTMPP_SectionRank" AS "ESTMPP_SectionRank"
        ...
        INNER JOIN "St_ThomosTotalDetails" "E" ON "E"."EME_Id" = "D"."EME_Id" AND "E"."ISMS_Id" = "B"."ISMS_Id"
        INNER JOIN "Exm"."Exm_Stu_MP_Promo_Subjectwise_Groupwise" "F" ON "F"."EMPSG_Id" = "C"."EMPSG_Id" AND "F"."EMPSG_Id" = "C"."EMPSG_Id"
        ...
        WHERE "G"."ASMAY_Id" = "@ASMAY_Id"::BIGINT 
            ...
            AND "I"."ASMCL_Id" = "@ASMCL_Id"::BIGINT
            AND "G"."AMST_Id" = "I"."AMST_Id"
        GROUP BY "E"."EME_Id", "E"."EMPSG_GroupName", "E"."EMPSG_DisplayName", "E"."AMST_Id", "A"."EMGR_Id", "I"."ESTMPP_SectionRank"
        ...
        SELECT DISTINCT 
            ...
            CAST((SUM("M"."ESTMPPSG_GroupObtMarks") * 100.0 / SUM("M"."ESTMPPSG_GroupMaxMarks")) AS DECIMAL(18,2)) AS "TotalPercentage",
            ''::VARCHAR AS "EMGD_Name",
            "I"."ESTMPP_SectionRank" AS "ESTMPP_SectionRank"
