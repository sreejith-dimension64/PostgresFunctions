CREATE OR REPLACE FUNCTION "dbo"."ISM_feedback_details_proc"(
    "p_HRME_Id" bigint,
...
RETURNS TABLE(
    ...
    "ISMDRF_Feedback_DR_Date" timestamp,
...
BEGIN
    ...
    SELECT 
        ...
        a."ISMDRF_FeedBack",
        a."CreatedDate",
        a."ISMDRF_Feedback_DR_Date",
        d."ISMDRPT_Date"
    FROM "dbo"."ISM_DailyReport_FeedBack" a
    LEFT JOIN "dbo"."HR_Master_Employee" b ON a."ISMDRF_Send_HRME_Id" = b."HRME_Id"
    INNER JOIN "dbo"."ISM_TaskCreation" c ON a."ISMTCR_Id" = c."ISMTCR_Id"
    LEFT JOIN "dbo"."ism_dailyreport" d ON c."ISMTCR_Id" = d."ISMTCR_Id"
