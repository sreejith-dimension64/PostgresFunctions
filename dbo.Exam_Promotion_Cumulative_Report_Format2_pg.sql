CREATE OR REPLACE FUNCTION "dbo"."Exam_Promotion_Cumulative_Report_Format2"(
    "p_MI_Id" TEXT,
    "p_ASMAY_Id" TEXT,
    "p_ASMCL_Id" TEXT,
    "p_ASMS_Id" TEXT,
...
BEGIN
    ...
    IF "p_FLAG" = 'P' OR "p_FLAG" = 'M' THEN
        ...
        "v_sqldynamic" := 'SELECT DISTINCT A."AMST_Id",A."ISMS_Id",D."ISMS_SubjectName",B."EMPSG_Id",C."EMPSG_GroupName",C."EMPSG_DisplayName", 
        B."ESTMPPSG_GroupMaxMarks", B."ESTMPPSG_GroupObtMarks", B."ESTMPPSG_GroupObtGrade", B."ESTMPPSG_GradePoints" , 
        CASE WHEN J."EMPS_SubjOrder" IS NULL THEN "ISMS_OrderFlag" ELSE J."EMPS_SubjOrder" END "EMPS_SubjOrder" , 
        N."EME_Id", N."ESTMPPSGE_ExamConvertedMarks",N."ESTMPPSGE_ExamConvertedGrade",N."ESTMPPSGE_ExamPassFailFlag"
        ...
        INNER JOIN "Exm"."Exm_Category_Class" M ON M."EMCA_Id"=L."EMCA_Id" AND M."ASMAY_Id"=' || "p_ASMAY_Id" || ' AND M."ASMCL_Id"=' || "p_ASMCL_Id" || ' AND M."ASMS_Id"=' || "p_ASMS_Id" || ' 
        AND M."ECAC_ActiveFlag"=1
        INNER JOIN "Exm"."Exm_Stu_MP_Promo_Subject_Groupwise_Exam" N ON N."ESTMPPSG_Id"=B."ESTMPPSG_Id"
        INNER JOIN "Exm"."Exm_Master_Exam" O ON O."EME_Id"=N."EME_Id"
        INNER JOIN "Exm"."Exm_M_Prom_Subj_Group_Exams" P ON P."EMPSG_Id"=C."EMPSG_Id" AND P."EME_Id"=O."EME_Id" AND P."EME_Id"=N."EME_Id"  AND P."EMPSGE_ActiveFlg"=1
    ...
    ELSIF "p_FLAG" = 'T' THEN
        ...
        "v_sqldynamic" := 'SELECT DISTINCT A."AMST_Id",A."ISMS_Id", A."EME_Id", H."ISMS_SubjectName", G."EME_ExamName" ,A."ESTMPS_MaxMarks" , 
        A."ESTMPS_ObtainedMarks", A."ESTMPS_ObtainedGrade", 
