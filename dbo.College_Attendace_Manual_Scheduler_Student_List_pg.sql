CREATE OR REPLACE FUNCTION "dbo"."College_Attendace_Manual_Scheduler_Student_List"(
    "p_MI_Id" TEXT,
    "p_ASMAY_Id" TEXT,
...
BEGIN
    ...
    IF "v_ASC_DefaultSMS_Flag" = 'F' THEN
        ...
        WHERE a."ASMAY_Id" = "p_ASMAY_Id"
            ...
            AND a."ACSA_AttendanceDate" = "p_ACSA_AttendanceDate"
            AND a."MI_Id" = "p_MI_Id"
            AND d."ASMAY_Id" = "p_ASMAY_Id";

        RETURN QUERY
        SELECT 
            CAST(B."ACSA_AttendanceDate" AS DATE) AS "ACSA_AttendanceDate",
            ...
            (SELECT STRING_AGG(A.subject, ', ')
             FROM temp11 A
             WHERE COALESCE(A."AMCST_MobileNo", 9999999999) = COALESCE(B."AMCST_MobileNo", 9999999999)
                 AND A."AMCST_FirstName" = B."AMCST_FirstName") AS subject
        FROM temp11 B
        GROUP BY CAST(B."ACSA_AttendanceDate" AS DATE), B."AMCST_FirstName", B."AMCO_CourseName", 
                 B."AMB_BranchName", B."AMSE_SEMName", B."AMCST_MobileNo", B."AMCST_Id";
    ...
    ELSIF "v_ASC_DefaultSMS_Flag" = 'M' THEN
        ...
        FROM temp11 B
        GROUP BY CAST(B."ACSA_AttendanceDate" AS DATE), B."AMCST_FirstName", B."AMCO_CourseName", 
                 B."AMB_BranchName", B."AMSE_SEMName", B."AMCST_Id", B."AMCST_MobileNo";
