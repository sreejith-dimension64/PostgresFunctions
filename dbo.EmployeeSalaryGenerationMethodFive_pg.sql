CREATE OR REPLACE FUNCTION "dbo"."EmployeeSalaryGenerationMethodFive"(
    p_HRME_ID BIGINT,
    p_MI_ID BIGINT,
    p_HRMLY_ID BIGINT,
...
DECLARE
    ...
    v_HRME_ESIDate DATE; v_HRME_PaymentType VARCHAR(50); v_HRMBD_BankName VARCHAR(50); v_HRMEB_AccountNo VARCHAR(50); v_HRMEB_ActiveFlag VARCHAR(50);
    ...
    v_CUR7HRMED_Id BIGINT; v_CUR7HRMED_AMOUNT DECIMAL(10,4); v_CUR7HRMED_EDTypeFlag VARCHAR(50); v_CUR7HRMED_EarnDedFlag VARCHAR(50); v_CUR7HRMED_RoundOffFlag VARCHAR(50);
    v_result DECIMAL(10,4); v_SALARYPERDAYPF DECIMAL(10,4);
    ...
    v_result1 DECIMAL(18,2); v_result2 DECIMAL(18,2); v_result3 DECIMAL(18,2);
    cur1 REFCURSOR; cur2 REFCURSOR; cur3 REFCURSOR; cur4 REFCURSOR; cur5 REFCURSOR; cur6 REFCURSOR; cur7 REFCURSOR; curpt REFCURSOR;
    curpf REFCURSOR; curpfmax REFCURSOR;
BEGIN
    ...
    ELSE
        v_MONTH_START_DATE := CONCAT(v_LEAVE_YEAR, '-', v_MONTH, '-', v_DAYFROM);
        v_DAYTO := EXTRACT(DAY FROM (DATE_TRUNC('MONTH', CAST(v_LEAVE_YEAR || '-' || v_MONTH || '-01' AS DATE)) + INTERVAL '1 MONTH - 1 day')::DATE);
    ...
    RAISE NOTICE 'basic pay %', v_BASICPAY;
    ...
    ELSE
        IF v_HRC_SalApprovalFlg = TRUE THEN
            INSERT INTO "HR_Employee_Salary"("MI_Id", "HRME_Id", "HRES_Year", "HRES_Month", "HRES_WorkingDays", "HRES_DailyRates", "HRES_EPF", "HRES_FPF", "HRES_Ac21", "HRES_Ac22", "HRES_Ac5", "HRES_FromDate", "HRES_ToDate", "HRES_ArrearRegFlag", "HRES_BankCashFlag", "HRMGT_Id", "HRMD_Id", "HRMDES_Id", "HRES_BankCode", "HRES_AccountNo", "HRES_ESIEmplr", "HRES_ApproveFlg", "HRES_CreatedDate", "HRES_UpdatedDate")
            VALUES (p_MI_ID, p_HRME_ID, v_LEAVE_YEAR, p_IVRM_Month_Name, v_WORKINGDAYS, v_SALARYPERDAY, NULL, NULL, NULL, NULL, NULL, CAST(v_MONTH_START_DATE AS DATE), CAST(v_MONTH_END_DATE AS DATE), NULL, v_HRME_PaymentType, v_EMPHRMGT_Id, v_EMPHRMD_Id, v_EMPHRMDES_Id, v_HRMBD_BankName, v_HRMEB_AccountNo, NULL, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
            RETURNING "HRES_ID" INTO v_NEW_IDENTITY;
        ELSE
            INSERT INTO "HR_Employee_Salary"("MI_Id", "HRME_Id", "HRES_Year", "HRES_Month", "HRES_WorkingDays", "HRES_DailyRates", "HRES_EPF", "HRES_FPF", "HRES_Ac21", "HRES_Ac22", "HRES_Ac5", "HRES_FromDate", "HRES_ToDate", "HRES_ArrearRegFlag", "HRES_BankCashFlag", "HRMGT_Id", "HRMD_Id", "HRMDES_Id", "HRES_BankCode", "HRES_AccountNo", "HRES_ESIEmplr", "HRES_ApproveFlg", "HRES_CreatedDate", "HRES_UpdatedDate")
            VALUES (p_MI_ID, p_HRME_ID, v_LEAVE_YEAR, p_IVRM_Month_Name, v_WORKINGDAYS, v_SALARYPERDAY, NULL, NULL, NULL, NULL, NULL, CAST(v_MONTH_START_DATE AS DATE), CAST(v_MONTH_END_DATE AS DATE), NULL, v_HRME_PaymentType, v_EMPHRMGT_Id, v_EMPHRMD_Id, v_EMPHRMDES_Id, v_HRMBD_BankName, v_HRMEB_AccountNo, NULL, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
            RETURNING "HRES_ID" INTO v_NEW_IDENTITY;
        END IF;
        RAISE NOTICE 'NEW_IDENTITY AS ID %', v_NEW_IDENTITY;
    END IF;
    ...
    LOOP
        FETCH cur1 INTO v_HRMED_IdCUR1, v_HREED_AmountCUR1, v_HRMED_EDTypeFlagCUR1, v_HRMED_EarnDedFlagCUR1, v_HRMED_AmountPercentFlagCUR1, v_HRMED_RoundOffFlagCUR1;
        EXIT WHEN NOT FOUND;
