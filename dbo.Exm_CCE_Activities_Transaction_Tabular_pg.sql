CREATE OR REPLACE FUNCTION "dbo"."Exm_CCE_Activities_Transaction_Tabular"(
    "MI_Id" TEXT,
    "ASMAY_Id" TEXT,
    "ASMCL_Id" TEXT,
    "ASMS_Id" TEXT,
...
INNER JOIN "exm"."Exm_CCE_Activities_Transaction" b 
INNER JOIN "Exm"."Exm_Master_Exam" c ON c."EME_Id" = b."EME_Id" AND c."EME_Id" IN (' || "EME_Id" || ')
 ON a."ECACT_Id" = b."ECACT_Id" WHERE b."MI_Id" = ' || "MI_Id" || ' AND b."EME_Id" IN (' || "EME_Id" || ') AND b."ASMAY_Id" = ' || "ASMAY_Id" || ' AND b."ASMCL_Id" = ' || "ASMCL_Id" || ' AND b."ASMS_Id" = ' || "ASMS_Id" || ' AND b."AMST_Id" IN (' || "AMST_Id" || ')';
