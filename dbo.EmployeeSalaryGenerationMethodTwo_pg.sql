CREATE OR REPLACE FUNCTION "dbo"."EmployeeSalaryGenerationMethodTwo"(
    p_HRME_ID BIGINT,
    p_MI_ID BIGINT,
    p_HRMLY_ID BIGINT,
...
DECLARE
    ...
    v_CUR5HRMED_ID BIGINT; v_CUR5HRMED_PERC VARCHAR(50); v_CUR5HRMED_EDTypeFlag VARCHAR(50); v_CUR5HRMED_EarnDedFlag VARCHAR(50); v_CUR5HRMED_AmountPercentFlag VARCHAR(50); v_CUR5HREED_Amount DECIMAL(18,2); v_CUR5HRMED_RoundOffFlag VARCHAR(50);

    v_CURPTHRMED_Id BIGINT; v_CURPTHRMEDP_HRMED_Id BIGINT; v_SUMAMOUNTPT DECIMAL(18,2); v_CALCAMOUNTPT DECIMAL(18,2);

    v_CURPFMAXHRMED_Id BIGINT; v_CURPFMAXHRMEDP_HRMED_Id BIGINT; v_SUMAMOUNTPFMAX DECIMAL(18,2); v_CALCAMOUNTPFMAX DECIMAL(18,2);

    v_CURPFHRMED_Id BIGINT; v_CURPFHRMEDP_HRMED_Id BIGINT; v_SUMAMOUNTPF DECIMAL(18,2); v_CALCAMOUNTPF DECIMAL(18,2);

    v_CUR6HRMED_Id BIGINT; v_CURHRMEDP_HRMED_Id BIGINT; v_SUMAMOUNT DECIMAL(18,2); v_CALCAMOUNT DECIMAL(18,2);
    ...
    v_result DECIMAL(18,2); v_result1 DECIMAL(18,2); v_result2 DECIMAL(18,2); v_result3 DECIMAL(18,2);
...
BEGIN
    ...
    SELECT "HRC_PFMaxAmt", "HRC_FPFPer", "HRC_EPFPer",
           ...
           "HRC_AC2MinAmount", "HRC_AC21MinAmount",
           "HRC_AC22MinAmount", "HRC_SalaryFromDay", "HRC_SalaryToDay", "HRC_SalApprovalFlg"
    INTO v_HRC_PFMAXAMT, v_HRC_FPFPER, v_HRC_EPFPER,
         ...
         v_HRC_AC2MinAmount, v_HRC_AC21MinAmount,
         v_HRC_AC22MinAmount, v_DAYFROM, v_DAYTO, v_HRC_SalApprovalFlg
    ...
    SELECT "HRMED"."HRMED_Id", "HREED"."HREED_Amount", "HRMED"."HRMED_EarnDedFlag",
           "HRMED"."HRMED_EDTypeFlag", "HRMED"."HRMED_RoundOffFlag"
    INTO v_HRMED_IdBasic, v_BASICPAY, v_HRMED_EarnDedFlagBasic,
         v_HRMED_EDTypeFlagBasic, v_HRMED_RoundOffFlag
    ...
    v_LOPAMOUNT := v_SALARYPERDAY * v_LOPDAYS;
    v_NEWBASICSALARY := v_BASICPAY - v_LOPAMOUNT;

    INSERT INTO "temp_salary_comp_detail" VALUES(p_MI_ID, p_HRME_ID, v_HRMED_IdBasic, v_NEWBASICSALARY, v_HRMED_EDTypeFlagBasic, v_HRMED_EarnDedFlagBasic, 'Amount', v_HRMED_RoundOffFlag);
    ...
    IF v_HRES_ID > 0 THEN
        IF v_HRC_SalApprovalFlg = TRUE THEN
            ...
            SET "MI_Id" = p_MI_ID, "HRME_Id" = p_HRME_ID, "HRES_Year" = v_LEAVE_YEAR, "HRES_Month" = p_IVRM_Month_Name, "HRES_WorkingDays" = v_WORKINGDAYS,
                "HRES_DailyRates" = v_SALARYPERDAY, "HRES_EPF" = NULL, "HRES_FPF" = NULL, "HRES_Ac21" = NULL, "HRES_Ac22" = NULL, "HRES_Ac5" = NULL,
                ...
                "HRES_BankCashFlag" = v_HRME_PaymentType, "HRES_BankCode" = v_HRMBD_BankName, "HRES_AccountNo" = v_HRMEB_AccountNo, "HRES_ApproveFlg" = FALSE
            WHERE "MI_Id" = p_MI_ID AND "HRME_Id" = p_HRME_ID AND "HRES_Year" = v_LEAVE_YEAR AND "HRES_Month" = p_IVRM_Month_Name;
        ELSE
            UPDATE "HR_Employee_Salary" 
            SET "MI_Id" = p_MI_ID, "HRME_Id" = p_HRME_ID, "HRES_Year" = v_LEAVE_YEAR, "HRES_Month" = p_IVRM_Month_Name, "HRES_WorkingDays" = v_WORKINGDAYS,
                ...
                "HRES_FromDate" = CAST(v_MONTH_START_DATE AS DATE), "HRES_ToDate" = CAST(v_MONTH_END_DATE AS DATE),
                "HRMGT_Id" = v_EMPHRMGT_Id, "HRMD_Id" = v_EMPHRMD_Id, "HRMDES_Id" = v_EMPHRMDES_Id,
                "HRES_BankCashFlag" = v_HRME_PaymentType, "HRES_BankCode" = v_HRMBD_BankName, "HRES_AccountNo" = v_HRMEB_AccountNo, "HRES_ApproveFlg" = TRUE
            WHERE "MI_Id" = p_MI_ID AND "HRME_Id" = p_HRME_ID AND "HRES_Year" = v_LEAVE_YEAR AND "HRES_Month" = p_IVRM_Month_Name;
        END IF;
    ...
    ELSE
        IF v_HRC_SalApprovalFlg = TRUE THEN
            INSERT INTO "HR_Employee_Salary" ("MI_Id", "HRME_Id", "HRES_Year", "HRES_Month", "HRES_WorkingDays", "HRES_DailyRates",
                                             "HRES_EPF", "HRES_FPF", "HRES_Ac21", "HRES_Ac22", "HRES_Ac5", "HRES_FromDate", "HRES_ToDate", "HRES_ArrearRegFlag",
                                             "HRES_BankCashFlag", "HRMGT_Id", "HRMD_Id", "HRMDES_Id", "HRES_BankCode", "HRES_AccountNo", "HRES_ESIEmplr", "HRES_ApproveFlg")
            VALUES (p_MI_ID, p_HRME_ID, v_LEAVE_YEAR, p_IVRM_Month_Name, v_WORKINGDAYS, v_SALARYPERDAY, NULL, NULL, NULL, NULL, NULL, CAST(v_MONTH_START_DATE AS DATE), CAST(v_MONTH_END_DATE AS DATE), NULL, v_HRME_PaymentType, v_EMPHRMGT_Id, v_EMPHRMD_Id, v_EMPHRMDES_Id, v_HRMBD_BankName, v_HRMEB_AccountNo, NULL, FALSE)
            RETURNING "HRES_ID" INTO v_NEW_IDENTITY;
        ELSE
            INSERT INTO "HR_Employee_Salary" ("MI_Id", "HRME_Id", "HRES_Year", "HRES_Month", "HRES_WorkingDays", "HRES_DailyRates",
                                             "HRES_EPF", "HRES_FPF", "HRES_Ac21", "HRES_Ac22", "HRES_Ac5", "HRES_FromDate", "HRES_ToDate", "HRES_ArrearRegFlag",
                                             "HRES_BankCashFlag", "HRMGT_Id", "HRMD_Id", "HRMDES_Id", "HRES_BankCode", "HRES_AccountNo", "HRES_ESIEmplr", "HRES_ApproveFlg")
            VALUES (p_MI_ID, p_HRME_ID, v_LEAVE_YEAR, p_IVRM_Month_Name, v_WORKINGDAYS, v_SALARYPERDAY, NULL, NULL, NULL, NULL, NULL, CAST(v_MONTH_START_DATE AS DATE), CAST(v_MONTH_END_DATE AS DATE), NULL, v_HRME_PaymentType, v_EMPHRMGT_Id, v_EMPHRMD_Id, v_EMPHRMDES_Id, v_HRMBD_BankName, v_HRMEB_AccountNo, NULL, TRUE)
            RETURNING "HRES_ID" INTO v_NEW_IDENTITY;
        END IF;
    END IF;
    ...
    FOR rec_cursor1 IN
        ...
        WHERE A."MI_Id" = p_MI_ID AND A."HRME_Id" = p_HRME_ID AND B."HRMED_AmountPercentFlag" = 'Amount' AND B."HRMED_ActiveFlag" = TRUE AND A."HREED_ActiveFlag" = TRUE
    ...
    LOOP
        v_HRMED_IdCUR1 := rec_cursor1."HRMED_Id";
        v_HREED_AmountCUR1 := rec_cursor1."HREED_Amount";
        v_HRMED_EDTypeFlagCUR1 := rec_cursor1."HRMED_EDTypeFlag";
        v_HRMED_EarnDedFlagCUR1 := rec_cursor1."HRMED_EarnDedFlag";
        v_HRMED_AmountPercentFlagCUR1 := rec_cursor1."HRMED_AmountPercentFlag";
        v_HRMED_RoundOffFlagCUR1 := rec_cursor1."HRMED_RoundOffFlag";
    ...
    FOR rec_cursor2 IN
        ...
        WHERE A."MI_Id" = p_MI_ID AND B."HRME_Id" = p_HRME_ID AND B."HREED_ActiveFlag" = TRUE AND A."HRMED_ActiveFlag" = TRUE AND
              A."HRMED_Id" NOT IN (SELECT "hrmed_id" FROM "temp_salary_comp_detail" WHERE "mi_id" = p_MI_ID AND "emp_id" = p_HRME_ID)
              AND A."HRMED_EarnDedFlag" = 'Earning'
    LOOP
        v_HRMEDP_HRMED_IdCUR2 := rec_cursor2."HRMED_Id";
        
        SELECT COUNT(*) INTO v_TEMPSALCOUNT FROM "temp