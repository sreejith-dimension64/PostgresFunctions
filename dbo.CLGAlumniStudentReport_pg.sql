CREATE OR REPLACE FUNCTION "dbo"."CLGAlumniStudentReport"(
    p_MI_Id TEXT,
    p_asmay_id TEXT,
    p_amco_id TEXT,
    p_amb_id TEXT,
...
WHERE stuyear."ASMAY_Id_Left" = ' || p_asmay_id || '
AND stuyear."AMCO_Left_Id"=' || p_amco_id || ' 
AND stuyear."AMB_Id_Left" IN (' || p_amb_id || ') AND stuyear."AMSE_Id_Left" IN (' || p_amse_id || ')';
