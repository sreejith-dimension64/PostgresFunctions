CREATE OR REPLACE FUNCTION "INV"."INV_openingUpdateOPB"(
    "p_MI_Id" bigint,
    "p_INVOB_Id" BIGINT,
    "p_INVMST_Id" bigint,
    "p_INVMI_Id" bigint,
...
BEGIN
    ...
    LOOP
        ...
        "v_item" := "rec"."INVMI_Id";
        "p_PurchaseDate" := "rec"."PurchaseDate";
        ...
        RAISE NOTICE '%', CAST("p_PurchaseDate" AS varchar(60));
        ...
        WHERE "INVMI_Id" = "v_item"
          ...
          AND "MI_Id" = "p_MI_Id"
          AND CAST("INVSTO_PurchaseDate" AS date) = CAST("p_PurchaseDate" AS date);
        ...
        IF "v_item" = "v_sitem"
           ...
           AND CAST("p_PurchaseDate" AS date) = "v_sPurchaseDate"
        ...
        THEN
            ...
            SET "INVOB_Qty" = "p_newqty",
                "INVOB_PurchaseDate" = CAST("p_PurchaseDate" AS date)
            WHERE "MI_Id" = "p_MI_Id" 
              AND "INVMST_Id" = "p_INVMST_Id" 
              AND "INVMI_Id" = "p_INVMI_Id" 
              AND "INVOB_PurchaseRate" = "p_INVOB_PurchaseRate" 
