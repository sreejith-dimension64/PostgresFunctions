CREATE OR REPLACE FUNCTION "dbo"."Admission_Update_DOB"(p_MI_Id TEXT)
RETURNS VOID
LANGUAGE plpgsql
AS $$
DECLARE
...
BEGIN
    ...
    FOR student_rec IN
        SELECT "AMST_Id", 
               TO_CHAR("amst_dob", 'DD/MM/YYYY') as amst_dob,
               "AMST_DOB_Words"
        FROM "Adm_M_Student" 
        WHERE "MI_Id" = p_MI_Id 
        AND (COALESCE("AMST_DOB_Words", '') = '' OR "AMST_DOB_Words" = 'NA')
    LOOP
        v_amst_id := student_rec."AMST_Id";
        v_dobdate := student_rec.amst_dob;
        v_dobwords := student_rec."AMST_DOB_Words";
        ...
        v_date := CASE WHEN v_date = '01' THEN 'FIRST' WHEN v_date = '02' THEN 'SECOND' WHEN v_date = '03' THEN 'THIRD' WHEN v_date = '04' THEN 'FOURTH' WHEN v_date = '05' THEN 'FIFTH'
                       ...
                       WHEN v_date = '17' THEN 'SEVENTEENTH' WHEN v_date = '18' THEN 'EIGHTEENTH' WHEN v_date = '19' THEN 'NINETEENTH' WHEN v_date = '20' THEN 'TWENTIETH' WHEN v_date = '21' THEN 'TWENTY FIRST'
                       ...
                       WHEN v_date = '27' THEN 'TWENTY SEVENTH' WHEN v_date = '28' THEN 'TWENTY EIGHTH' WHEN v_date = '29' THEN 'TWENTY NINTH' WHEN v_date = '30' THEN 'THIRTIETH' WHEN v_date = '31' THEN 'THIRTY FIRST' ELSE '' END;
        ...
        v_yearname123 := CASE WHEN v_dob1 = '01' THEN 'ONE' WHEN v_dob1 = '02' THEN 'TWO'
                              ...
                              WHEN v_dob1 = '09' THEN 'NINE' WHEN v_dob1 = '10' THEN 'TEN' WHEN v_dob1 = '11' THEN 'ELEVEN' WHEN v_dob1 = '12' THEN 'TWELVE' WHEN v_dob1 = '13' THEN 'THIRTEEN' WHEN v_dob1 = '14' THEN 'FOURTEEN'
