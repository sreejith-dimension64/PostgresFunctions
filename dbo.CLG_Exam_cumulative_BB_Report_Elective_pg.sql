CREATE OR REPLACE FUNCTION "dbo"."CLG_Exam_cumulative_BB_Report_Elective"(
    p_AMCO_Id bigint,
    p_AMB_Id bigint,
    p_ACSS_Id bigint,
    p_MI_Id bigint,
...
BEGIN
    ...
    GROUP BY "AMCS"."AMCST_Id", "AMCS"."AMCST_FirstName", "AMCS"."AMCST_MiddleName", "AMCS"."AMCST_LastName", 
        ...
        "AMB"."AMB_BranchName", "AMS"."AMSE_SEMName", "ACMS"."ACMS_SectionName", "EMGD1"."EMGD_Remarks", 
        "ECSMP"."ECSTMP_TotalObtMarks", "ECSMP"."ECSTMP_TotalMaxMarks", "ECSMP"."ECSTMP_Percentage", 
        "ECSMP"."ECSTMP_TotalGrade", "ECSMP"."ECSTMP_SemRank", "ECSMP"."ECSTMP_SectionRank", "EMGD2"."EMGD_Remarks", 
        "ECSMP"."ECSTMP_TotalObtMarks", "MI"."MI_name", "CEYCES"."ECYSES_SubjectOrder", 
        "CEYCE"."ECYSE_AttendanceFromDate", "CEYCE"."ECYSE_AttendanceToDate", "ECSMP"."ECSTMP_Result"
