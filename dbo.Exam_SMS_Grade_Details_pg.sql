CREATE OR REPLACE FUNCTION "dbo"."Exam_SMS_Grade_Details"(
    p_ASMAY_Id TEXT,
    p_ASMCL_Id TEXT,
    p_ASMS_Id TEXT,
    p_MI_Id TEXT,
...
BEGIN
    ...
    IF p_ASMS_Id != '0' THEN
        ...
        SELECT DISTINCT 
            a."AMST_Id",
            (COALESCE("AMST_FirstName",' ') || ' ' || COALESCE("AMST_MiddleName",'') || ' ' || COALESCE("AMST_LastName",'')) as "AMST_Name",
            b."AMST_AdmNo",
            b."AMST_emailId",
            b."AMST_MobileNo",
        ...
        SELECT 
            ...
            (STRING_AGG(DISTINCT A."GradeDetails", ', ' ORDER BY A."GradeDetails") || ' ' || 
             STRING_AGG(DISTINCT A."TotalGrade", ', ' ORDER BY A."TotalGrade")) AS "MARKS"
        FROM schoolstudent B
