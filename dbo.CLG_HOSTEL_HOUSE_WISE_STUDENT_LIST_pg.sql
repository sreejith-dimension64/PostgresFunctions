CREATE OR REPLACE FUNCTION "dbo"."CLG_HOSTEL_HOUSE_WISE_STUDENT_LIST"(
    "MI_Id" BIGINT,
    "ASMAY_Id" BIGINT,
    "HLMH_Id" BIGINT
)
...
BEGIN
    ...
    INNER JOIN "CLG"."Adm_Master_College_Student" "AMST" ON "AMST"."AMCST_Id" = "HSR"."AMCST_Id" AND "AMST"."AMCST_SOL" = 'S' AND "AMST"."AMCST_ActiveFlag" = 1
    INNER JOIN "CLG"."Adm_College_Yearly_Student" "AYS" ON "AYS"."AMCST_Id" = "AMST"."AMCST_Id" AND "AYS"."ACYST_ActiveFlag" = 1
