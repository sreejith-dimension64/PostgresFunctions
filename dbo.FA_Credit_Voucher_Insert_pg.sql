CREATE OR REPLACE FUNCTION "dbo"."FA_Credit_Voucher_Insert"(
    p_MI_Id bigint,
    p_FAMCOMP_Id bigint,
    p_IMFY_Id bigint,
    p_CFAMLED_Id bigint,
...
BEGIN
    ...
    VALUES(p_MI_Id,p_FAMCOMP_Id,p_IMFY_Id,'JournalVoucher','',p_date,p_remarks,'','','','JournalVoucher','',0,p_r_no,1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
