CREATE OR REPLACE FUNCTION "dbo"."Adm_School_SubjectwiseAttendance_AbsentSMS"(
    p_MI_Id TEXT,
    p_ASMAY_Id TEXT,
    p_ASMCL_Id TEXT,
    p_ASMS_Id TEXT,
...
BEGIN
    ...
    LEFT JOIN "SubjectwiseAttendance_Temp" "A1" 
    ...
    AND "AMS"."AMST_SOL" = 'S'
    AND "AMS"."AMST_Id" = ANY(STRING_TO_ARRAY(p_AMST_Id, ',')::BIGINT[])
    AND "AMS"."AMST_ActiveFlag" = 1
    AND "ASYS"."AMAY_ActiveFlag" = 1
    GROUP BY "A2"."ISMS_Id", "A2"."ISMS_SubjectName", "A2"."ASA_FromDate", "A2"."AMonthName", 
             "A2"."AMST_Id", "AMS"."AMST_FirstName", "AMS"."AMST_MiddleName", "AMS"."AMST_LastName",
             "AMS"."AMST_AdmNo", "ASYS"."AMAY_RollNo";
