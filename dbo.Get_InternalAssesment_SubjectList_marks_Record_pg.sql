CREATE OR REPLACE FUNCTION "dbo"."Get_InternalAssesment_SubjectList_marks_Record"(
    p_MI_Id bigint,
    p_ASMAY_Id bigint,
    p_ASMCL_Id bigint,
    p_ASMS_Id bigint,
...
RETURNS TABLE(
    ...
    "flag" bit,
    "EYCES_MarksDisplayFlg" bit,
    "EYCES_GradeDisplayFlg" bit
)
LANGUAGE plpgsql
AS $$
BEGIN
    RETURN QUERY
    SELECT DISTINCT 
        e."ISMS_Id" AS "ISMS_Id",
        f."Isms_SubjectName" AS "subjectname",
        f."ISMS_OrderFlag",
        e."EYCES_AplResultFlg" AS "flag",
