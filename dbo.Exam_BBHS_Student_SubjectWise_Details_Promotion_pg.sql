CREATE OR REPLACE FUNCTION "dbo"."Exam_BBHS_Student_SubjectWise_Details_Promotion"(
    "@MI_Id" TEXT,
    "@ASMAY_Id" TEXT,
    "@ASMCL_Id" TEXT,
    "@ASMS_Id" TEXT,
...
BEGIN
    IF "@FLAG" = '1' THEN
        ...
        INNER JOIN "EXM"."Exm_Category_Class" H ON H."ASMAY_Id" = E."ASMAY_Id" AND H."ASMCL_Id" = F."ASMCL_Id" 
            ...
            AND H."ASMCL_Id" = "@ASMCL_Id"::BIGINT AND H."ASMAY_Id" = "@ASMAY_Id"::BIGINT AND H."ASMS_Id" = "@ASMS_Id"::BIGINT
        ...
        INNER JOIN "EXM"."Exm_Yearly_Category" J ON J."ASMAY_Id" = E."ASMAY_Id" AND J."EMCA_Id" = I."EMCA_Id" 
            AND J."ASMAY_Id" = "@ASMAY_Id"::BIGINT AND J."EYC_ActiveFlg" = TRUE
        ...
        INNER JOIN "EXM"."Exm_Yrly_Cat_Exams_Subwise" M ON M."EYCE_Id" = K."EYCE_Id" 
            AND M."ISMS_Id" = B."ISMS_Id" AND M."EYCES_ActiveFlg" = TRUE
        WHERE C."ASMAY_Id" = "@ASMAY_Id"::BIGINT AND A."ASMAY_Id" = "@ASMAY_Id"::BIGINT
            AND A."ASMCL_Id" = "@ASMCL_Id"::BIGINT AND C."ASMCL_Id" = "@ASMCL_Id"::BIGINT 
            AND A."ASMS_Id" = "@ASMS_Id"::BIGINT AND C."ASMS_Id" = "@ASMS_Id"::BIGINT
    ...
    ELSIF "@FLAG" = '2' THEN
        ...
        WHERE A."MI_Id" = "@MI_Id"::BIGINT AND A."ASMAY_Id" = "@ASMAY_Id"::BIGINT 
            AND A."ASMCL_Id" = "@ASMCL_Id"::BIGINT AND A."ASMS_Id" = "@ASMS_Id"::BIGINT
            AND C."ASMAY_Id" = "@ASMAY_Id"::BIGINT AND C."ASMCL_Id" = "@ASMCL_Id"::BIGINT 
            AND C."ASMS_Id" = "@ASMS_Id"::BIGINT AND A."ASA_Activeflag" = TRUE
        GROUP BY B."AMST_Id";
