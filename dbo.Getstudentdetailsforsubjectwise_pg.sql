CREATE OR REPLACE FUNCTION "dbo"."Getstudentdetailsforsubjectwise"(
    p_yearid TEXT,
    p_miid VARCHAR(100),
    p_id TEXT,
    p_asmcl_id TEXT,
...
BEGIN
    ...
    IF p_id = '1' THEN  -- for gender asc
        IF p_asms_id = '0' THEN
            ...
            INNER JOIN "Adm_School_Y_Student" ystd ON ystd."AMST_Id" = mstd."AMST_Id" 
            INNER JOIN "exm"."Exm_Studentwise_Subjects" a ON a."AMST_Id" = ystd."AMST_Id"
            WHERE ystd."ASMAY_Id" = p_yearid AND ystd."ASMCL_Id" = p_asmcl_id 
                AND mstd."AMST_ActiveFlag" = 1 AND mstd."MI_Id" = p_miid 
                AND mstd."AMST_SOL" = v_flag AND mstd."AMST_Date" <= CURRENT_TIMESTAMP 
                AND ystd."AMAY_ActiveFlag" = 1
                AND a."ISMS_Id" = p_isms_id AND a."ASMAY_Id" = p_yearid AND a."ASMCL_Id" = p_asmcl_id
        ...
        ELSE
            ...
            WHERE ystd."ASMAY_Id" = p_yearid AND ystd."ASMCL_Id" = p_asmcl_id AND ystd."ASMS_Id" = p_asms_id 
                ...
                AND mstd."AMST_SOL" = v_flag AND mstd."AMST_Date" <= CURRENT_TIMESTAMP 
                AND ystd."AMAY_ActiveFlag" = 1
                AND a."ISMS_Id" = p_isms_id AND a."ASMAY_Id" = p_yearid 
