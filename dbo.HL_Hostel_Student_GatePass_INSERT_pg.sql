CREATE OR REPLACE FUNCTION "dbo"."HL_Hostel_Student_GatePass_INSERT"(
    p_MI_Id bigint,
    p_HLHSTGP_Id bigint,
...
BEGIN
    ...
    FROM "IVRM_User_Login_Student_College" 
    ...
    ELSE
        ...
        VALUES
        (p_MI_Id, v_AMCST_Id, p_HLHSTGP_TypeFlg, p_HLHSTGP_GoingOutDate, p_HLHSTGP_GoingOutTime, 
         p_HLHSTGP_Reason, p_HLHSTGP_ComingBackDate, v_HLHSTGP_TotalDays, true);
    END IF;
