CREATE OR REPLACE FUNCTION "dbo"."Exam_VVEHPC_Studentwise_Marks_Details_Promotion_New"(
    p_MI_Id TEXT,
    p_ASMAY_Id TEXT,
    p_ASMCL_Id TEXT,
    p_ASMS_Id TEXT,
...
BEGIN
    ...
    SELECT * FROM (
        SELECT DISTINCT 
            ...
            CAST(I."EYCES_MarksDisplayFlg" AS VARCHAR) AS "eyceS_MarksDisplayFlg",
            CAST(I."EYCES_GradeDisplayFlg" AS VARCHAR) AS "eyceS_GradeDisplayFlg"
        ...
        WHERE A."MI_Id" = p_MI_Id::BIGINT 
            ...
            AND A."AMST_Id" IN (SELECT CAST(unnest(string_to_array(p_AMST_Id, ',')) AS BIGINT))
