CREATE OR REPLACE FUNCTION "dbo"."Adm_Study_certificate_modified"(
    "yearId" TEXT,
    "classid" TEXT,
    "sectionid" TEXT,
    "studid" TEXT,
...
SELECT 
    ...
    "Adm_M_Student"."AMST_AdmNo" AS "admNo",
    (COALESCE("Adm_M_Student"."AMST_PerStreet", '') || ',' || COALESCE("Adm_M_Student"."AMST_PerArea", '') || ',' || COALESCE("Adm_M_Student"."AMST_PerCity", '') || ',' || COALESCE("IVRM_Master_State"."ivrmms_name", '') || ',' || COALESCE("IVRM_Master_Country"."IVRMMC_CountryName", '')) AS "addressd12",
    ...
    "Adm_M_Student"."amst_Taluk" AS "Taluk",
    "Adm_M_Student"."AMST_Distirct" AS "Distirct",
    "Adm_M_Student"."AMST_village" AS "village",
    "Adm_M_Student"."AMST_Date" AS "joindate",
    "IVRM_Master_Caste"."IMC_CasteName" AS "caste_name",
    "IVRM_Master_Religion"."IVRMMR_Name" AS "religion",
    "Adm_M_Student"."AMST_ConStreet" AS "constreet",
    "Adm_M_Student"."AMST_ConArea" AS "conarea",
    "Adm_M_Student"."AMST_ConCity" AS "concity",
    "Master_Institution"."MI_Logo",
    "Master_Institution"."IVRMMCT_Name",
    ...
    )) || ' ' || CAST("Adm_M_Student"."AMST_PerPincode" AS VARCHAR) AS "addressd1",
    ...
    (SELECT "b"."IVRMMC_CountryName" 
     FROM "adm_m_student" "a" 
     INNER JOIN "IVRM_Master_Country" "b" ON "a"."AMST_ConCountry" = "b"."IVRMMC_Id" 
     WHERE "a"."amst_id" = "Adm_Study_certificate_modified"."studid" 
     LIMIT 1) || 
    ' ' || CAST("Adm_M_Student"."AMST_ConPincode" AS VARCHAR) AS "addressd13"
...
LEFT JOIN "Master_Institution" ON "Adm_M_Student"."MI_Id" = "Master_Institution"."MI_Id"
WHERE "Adm_School_Y_Student"."AMST_Id" = "Adm_Study_certificate_modified"."studid"::BIGINT 
  AND "Adm_School_M_Academic_Year"."ASMAY_Id" = "Adm_Study_certificate_modified"."yearId"::BIGINT 
  AND "Adm_M_Student"."MI_Id" = "Adm_Study_certificate_modified"."mi_id"::BIGINT;
