CREATE OR REPLACE FUNCTION "dbo"."defaulters_report" (
    p_fmg_id TEXT,
    p_ASMAY_ID TEXT,
    p_amsc_id TEXT,
    p_type TEXT,
            ...
            IF p_option = 'FSW' THEN
                IF p_busroute = '0' THEN
                    IF p_left = '1' AND p_active = '1' AND p_deactive = '0' THEN
                        ...
                        ' || v_str1 || ' AND ("Adm_School_Y_Student"."AMAY_ActiveFlag" = TRUE) AND ("Adm_M_Student"."AMST_SOL" = ''S'') AND ("Adm_M_Student"."AMST_ActiveFlag" = TRUE) 
                        ...
                        INNER JOIN "Fee_Master_Terms" ON "Fee_Master_Terms"."FMT_Id" = "Fee_Master_Terms_FeeHeads"."FMT_Id" AND "Fee_Student_Status"."FTI_Id" = "Fee_Master_Terms_FeeHeads"."FTI_Id" 
                        INNER JOIN "Adm_School_M_Academic_Year" ON "Adm_School_M_Academic_Year"."ASMAY_Id" = "Adm_School_Y_Student"."ASMAY_Id" AND "Adm_School_M_Academic_Year"."ASMAY_Id" = "fee_student_status"."ASMAY_Id" 
                        ' || v_str1 || ' AND ("Adm_School_Y_Student"."AMAY_ActiveFlag" = FALSE) AND ("Adm_M_Student"."AMST_SOL" = ''L'') AND ("Adm_M_Student"."AMST_ActiveFlag" = FALSE) 
                        GROUP BY "Adm_School_M_Class"."ASMCL_ClassName", "Adm_School_M_Section"."ASMC_SectionName", "Adm_M_Student"."AMST_MobileNo", "AMST_FirstName", "AMST_MiddleName", "AMST_LastName", "Adm_M_Student"."AMST_AdmNo", "Adm_M_Student"."AMST_FatherName", "AMST_emailId", "Adm_M_Student"."AMST_Id"';
                    ELSIF p_left = '1' AND p_active = '0' AND p_deactive = '1' THEN
                        ...
                        INNER JOIN "Fee_Master_Terms" ON "Fee_Master_Terms"."FMT_Id" = "Fee_Master_Terms_FeeHeads"."FMT_Id" AND "Fee_Student_Status"."FTI_Id" = "Fee_Master_Terms_FeeHeads"."FTI_Id" 
                        INNER JOIN "Adm_School_M_Academic_Year" ON "Adm_School_M_Academic_Year"."ASMAY_Id" = "Adm_School_Y_Student"."ASMAY_Id" AND "Adm_School_M_Academic_Year"."ASMAY_Id" = "fee_student_status"."ASMAY_Id" 
                        ' || v_str1 || ' AND ("Adm_School_Y_Student"."AMAY_ActiveFlag" = TRUE) AND ("Adm_M_Student"."AMST_SOL" = ''D'') AND ("Adm_M_Student"."AMST_ActiveFlag" = TRUE) 
                        GROUP BY "Adm_School_M_Class"."ASMCL_ClassName", "Adm_School_M_Section"."ASMC_SectionName", "Adm_M_Student"."AMST_MobileNo", "AMST_FirstName", "AMST_MiddleName", "AMST_LastName", "Adm_M_Student"."AMST_AdmNo", "Adm_M_Student"."AMST_FatherName", "AMST_emailId", "Adm_M_Student"."AMST_Id"';
                    ELSIF p_left = '0' AND p_active = '1' AND p_deactive = '1' THEN
                        ...
                        INNER JOIN "Adm_School_Y_Student" ON "Adm_School_Y_Student"."AMST_Id" = "Adm_M_Student"."AMST_Id" 
                        INNER JOIN "Adm_School_M_Class" ON "Adm_School_M_Class"."ASMCL_Id" = "Adm_School_Y_Student"."ASMCL_Id" 
                        INNER JOIN "Adm_School_M_Section" ON "Adm_School_M_Section"."ASMS_Id" =