CREATE OR REPLACE FUNCTION "dbo"."CHAIRMAN_LOGIN_COUNT_STUDENT_MOBILE"(
    "USERId" BIGINT,
    "FRMDATE" DATE,
    "TODATE" DATE,
    "TYPE" TEXT
...
BEGIN
    ...
    IF "TYPE" = 'L' THEN
        ...
        WHERE C."IVRMRT_Role" IN ('student') 
    ...
    ELSIF "TYPE" = 'D' THEN
        ...
        WHERE A."MI_Id" IN (
            ...
            AND A."AMST_AppDownloadedDeviceId" <> '0' 
            AND A."AMST_AppDownloadedDeviceId" IS NOT NULL  
            AND A."AMST_AppDownloadedDeviceId" <> ''
