CREATE OR REPLACE FUNCTION "dbo"."Exam_Studentwise_Marks_Details_Promotion_New"(
    p_MI_Id TEXT,
    p_ASMAY_Id TEXT,
    p_ASMCL_Id TEXT,
    p_ASMS_Id TEXT
...
BEGIN
    ...
    DROP TABLE IF EXISTS "BGHS_EXAM_PROMOTION_DETIAL1_N";

    CREATE TEMP TABLE "BGHS_EXAM_PROMOTION_DETIAL1_N" (
        "AMST_Id" BIGINT,
        "ISMS_Id" BIGINT,
        "EME_Id" BIGINT,
        "GROUPNAME" TEXT,
    ...
    LOOP
        ...
        FOR v_GROUPNAME, v_DISPLAYNAME, v_GROUPORDER IN
            ...
            WHERE C."EYC_Id"=v_EYC_Id AND C."MI_Id"=p_MI_Id::BIGINT AND A."EMPSG_ActiveFlag"=1 AND B."EMPS_ActiveFlag"=1
        LOOP

            FOR v_EMEID, v_EMEORDER IN
                ...
                WHERE C."EYC_Id"=v_EYC_Id AND C."MI_Id"=p_MI_Id::BIGINT AND A."EMPSG_ActiveFlag"=1 
                AND B."EMPS_ActiveFlag"=1 AND A."EMPSG_GroupName"=v_GROUPNAME 
            ...
            LOOP
                ...
                FOR v_ISMS_Id_N IN
                    ...
                    INNER JOIN "Exm"."Exm_Yearly_Category" EYC ON CC."EMCA_Id"=EYC."EMCA_Id" AND EYC."ASMAY_Id"=CC."ASMAY_Id" AND CC."MI_Id"=EYC."MI_Id"
                    ...
                    WHERE CC."MI_Id"=p_MI_Id::BIGINT AND CC."ASMAY_Id"=p_ASMAY_Id::BIGINT AND CC."ASMCL_Id"=p_ASMCL_Id::BIGINT 
                    AND CC."ASMS_Id"=p_ASMS_Id::BIGINT AND EYC."EYC_ActiveFlg"=1 
                    AND CC."ECAC_ActiveFlag"=1 AND EYC."EYC_Id"=v_EYC_Id AND CC."EMCA_Id"=v_EMCA_Id AND CE."EME_Id"=v_EMEID
                    AND "ISMS_Id" IN (
                        SELECT DISTINCT "ISMS_Id" 
                        FROM "Exm"."Exm_Student_Marks_Process_Subjectwise" ESS 
                        WHERE ESS."AMST_Id"=v_AMST_Id_N AND ESS."ASMAY_Id"=p_ASMAY_Id::BIGINT 
                        AND ESS."MI_Id"=p_MI_Id::BIGINT AND ESS."ASMCL_Id"=p_ASMCL_Id::BIGINT AND ESS."ASMS_Id"=p_ASMS_Id::BIGINT
                    )
                LOOP
                    ...
                    WHERE "MI_Id"=p_MI_Id::BIGINT AND "ASMAY_Id"=p_ASMAY_Id::BIGINT AND "ASMCL_Id"=p_ASMCL_Id::BIGINT 
                    AND "ASMS_Id"=p_ASMS_Id::BIGINT AND "EME_Id"=v_EMEID AND "AMST_Id"=v_AMST_Id_N AND "ISMS_Id"=v_ISMS_Id_N;

                    IF v_ROW_COUNT <> 0 THEN
                        v_EXAMATTENDED_NOTATTENDED_FLAG := 'Attendend';
                        INSERT INTO "BGHS_EXAM_PROMOTION_DETIAL1_N" (
                        ...
                        SELECT "AMST_Id", "ISMS_Id", "EME_Id", v_GROUPNAME, v_DISPLAYNAME, "ESTMPS_ObtainedMarks", 
                               "ESTMPS_MaxMarks", "ESTMPS_ObtainedGrade", "ESTMPS_PassFailFlg", v_EXAMATTENDED_NOTATTENDED_FLAG, 1
                        FROM "Exm"."Exm_Student_Marks_Process_Subjectwise" 
                        WHERE "MI_Id"=p_MI_Id::BIGINT AND "ASMAY_Id"=p_ASMAY_Id::BIGINT AND "ASMCL_Id"=p_ASMCL_Id::BIGINT 
                        AND "ASMS_Id"=p_ASMS_Id::BIGINT AND "EME_Id"=v_EMEID AND "AMST_Id"=v_AMST_Id_N AND "ISMS_Id"=v_ISMS_Id_N;
                    ELSE
                        ...
                        SELECT v_AMST_Id_N, v_ISMS_Id_N, v_EMEID, v_GROUPNAME, v_DISPLAYNAME, 0, 0, '', '', v_EXAMATTENDED_NOTATTENDED_FLAG, 0;
                ...
                FROM "BGHS_EXAM_PROMOTION_DETIAL1_N" 
                WHERE "ISMS_Id" IN (
                    SELECT DISTINCT "ISMS_Id" 
                    FROM "Exm"."Exm_Category_Class" CC 
                    INNER JOIN "Exm"."Exm_Yearly_Category" EYC ON CC."EMCA_Id"=EYC."EMCA_Id" AND EYC."ASMAY_Id"=CC."ASMAY_Id" AND CC."MI_Id"=EYC."MI_Id"
                    ...
                    WHERE CC."MI_Id"=p_MI_Id::BIGINT AND CC."ASMAY_Id"=p_ASMAY_Id::BIGINT AND CC."ASMCL_Id"=p_ASMCL_Id::BIGINT 
                    AND CC."ASMS_Id"=p_ASMS_Id::BIGINT AND EYC."EYC_ActiveFlg"=1 
                    AND CC."ECAC_ActiveFlag"=1 AND EYC."EYC_Id"=v_EYC_Id AND CC."EMCA_Id"=v_EMCA_Id 
                    AND CE."EME_Id"=v_EMEID AND "EYCES_AplResultFlg"=1
                ) 
                AND "AMST_Id"=v_AMST_Id_N AND "EME_Id"=v_EMEID AND "GROUPNAME"=v_GROUPNAME AND "ExamConductFlag"=0;
                ...
                SELECT "AMST_Id", 50001, "EME_Id", v_GROUPNAME, v_DISPLAYNAME, "ESTMP_TotalObtMarks", 
                       "ESTMP_TotalMaxMarks", "ESTMP_TotalGrade", "ESTMP_Result", '', v_AppResultcountFlag
                FROM "Exm"."Exm_Student_Marks_Process" 
                WHERE "MI_Id"=p_MI_Id::BIGINT AND "ASMAY_Id"=p_ASMAY_Id::BIGINT AND "ASMCL_Id"=p_ASMCL_Id::BIGINT 
                AND "ASMS_Id"=p_ASMS_Id::BIGINT AND "EME_Id"=v_EMEID AND "AMST_Id"=v_AMST_Id_N;

            END LOOP;

            FOR v_ISMS_Id_New IN
                ...
                INNER JOIN "Exm"."Exm_M_Prom_Subj_Group" D ON D."EMPS_Id"=B."EMPS_Id" AND D."EMPSG_ActiveFlag"=1
                WHERE A."EYC_Id"=v_EYC_Id AND B."EMPS_ActiveFlag"=1 AND A."EMP_ActiveFlag"=1 AND D."EMPSG_GroupName"=v_GROUPNAME
            LOOP
                ...
                SELECT A."AMST_Id", A."ISMS_Id", 10000, v_GROUPNAME, v_DISPLAYNAME, B."ESTMPPSG_GroupObtMarks", 
                       B."ESTMPPSG_GroupMaxMarks", B."ESTMPPSG_GroupObtGrade", '', '', v_EXAM_CONDUCT_FLAG
                ...
                WHERE A."MI_Id"=p_MI_Id::BIGINT AND A."ASMAY_Id"=p_ASMAY_Id::BIGINT AND A."ASMCL_Id"=p_ASMCL_Id::BIGINT 
                AND A."ASMS_Id"=p_ASMS_Id::BIGINT AND C."EMPSG_GroupName"=v_GROUPNAME
                ...
                SELECT A."AMST_Id", A."ISMS_Id", 100001, v_GROUPNAME, v_DISPLAYNAME, B."ESTMPPSG_GroupObtMarks", 
                       B."ESTMPPSG_GroupMaxMarks", B."ESTMPPSG_GroupObtGrade", '', '', v_EXAM_CONDUCT_FLAG
                FROM "Exm"."Exm_Stu_MP_Promo_Subjectwise" A 
                INNER JOIN "Exm"."Exm_Stu_MP_Promo_Subjectwise_Groupwise" B ON A."ESTMPPS_Id"=B."ESTMPPS_Id"
                INNER JOIN "Exm"."Exm_M_Prom_Subj_Group" C ON C."EMPSG_Id"=B."EMPSG_Id"
                WHERE A."MI_Id"=p_MI_Id::BIGINT AND A."ASMAY_Id"=p_ASMAY_Id::BIGINT AND A."ASMCL_Id"=p_ASMCL_Id::BIGINT 
                AND A."ASMS_Id"=p_ASMS_Id::BIGINT AND C."EMPSG_GroupName"=v_GROUPNAME
                AND A."ISMS_Id"=v_ISMS_Id_New AND A."AMST_Id"=v_AMST_Id_N AND A."ISMS_Id"=v_ISMS_Id_New;
            ...
            WHERE "ISMS_Id" IN (
                ...
                INNER JOIN "Exm"."Exm_Category_Class" E ON E."EMCA_Id"=D."EMCA_Id" AND E."ASMAY_Id"=p_ASMAY_Id::BIGINT 
                AND E."ASMCL_Id"=p_ASMCL_Id::BIGINT AND E."ASMS_Id"=p_ASMS_Id::BIGINT 
                AND E."ECAC_ActiveFlag"=1 AND B."EMPS_AppToResultFlg"=1
            ) 
            AND "ExamConductFlag"=0 AND "EME_Id"=10000 AND "GROUPNAME"=v_GROUPNAME AND "AMST_Id"=v_AMST_Id_N;
            ...
            SELECT A."AMST_Id", 50001, 10000, v_GROUPNAME, v_GROUPNAME, SUM(B."ESTMPPSG_GroupObtMarks"), 
                   SUM(B."ESTMPPSG_GroupMaxMarks"), '', '', '', v_COUNT_FLAG
            FROM "Exm"."Exm_Stu_MP_Promo_Subjectwise" A
            INNER JOIN "Exm"."Exm_Stu_MP_Promo_Subjectwise_Groupwise" B ON A."ESTMPPS_Id"=B."ESTMPPS_Id"
            INNER JOIN "Exm"."Exm_M_Prom_Subj_Group" C ON C."EMPSG_Id"=B."EMPSG_Id"
            WHERE A."MI_Id"=p_MI_Id::BIGINT AND A."ASMAY_Id"=p_ASMAY_Id::BIGINT AND A."ASMCL_Id"=p_ASMCL_Id::BIGINT 
            AND A."ASMS_Id"=p_ASMS_Id::BIGINT AND C."EMPSG_GroupName"=v_GROUPNAME AND A."AMST_Id"=v_AMST_Id_N
            AND A."ISMS_Id" IN (
                SELECT "ISMS_Id" 
                FROM "Exm"."Exm_M_Promotion" A 
                INNER JOIN "Exm"."Exm_M_Promotion_Subjects" B ON A."EMP_Id"=B."EMP_Id" AND A."EMP_ActiveFlag"=1 AND B."EMPS_ActiveFlag"=1
            ...
            SELECT A."AMST_Id", 50001, 100001, v_GROUPNAME, v_GROUPNAME, SUM(B."ESTMPPSG_GroupObtMarks"), 
                   SUM(B."ESTMPPSG_GroupMaxMarks"), '', '', '', v_COUNT_FLAG
            FROM "Exm"."Exm_Stu_MP_Promo_Subjectwise" A 
            INNER JOIN "Exm"."Exm_Stu_MP_Promo_Subjectwise_Groupwise" B ON A."ESTMPPS_Id"=B."ESTMPPS_Id"
            INNER JOIN "Exm"."Exm_M_Prom_Subj_Group" C ON C."EMPSG_Id"=B."EMPSG_Id"
    ...
    RETURN QUERY SELECT * FROM "BGHS_EXAM_PROMOTION_DETIAL1_N";
