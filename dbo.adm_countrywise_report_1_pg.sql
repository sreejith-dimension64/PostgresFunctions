CREATE OR REPLACE FUNCTION "dbo"."adm_countrywise_report_1"(
    "MI_Id" TEXT,
    "ASMAY_Id" TEXT,
    "ASMCL_Id" TEXT,
    "ASMS_ID" TEXT,
...
BEGIN
    "sql" := 'SELECT a."AMST_Id",
        ...
        con."IVRMMC_CountryName" AS countryname
    ...
    WHERE a."MI_Id" IN (' || "MI_Id" || ')
        ...
        AND con."IVRMMC_Id" = ' || "country_id" || '
        AND a."AMST_SOL" = ''S''
        AND b."AMAY_ActiveFlag" = 1
        AND a."AMST_ActiveFlag" = 1
    ORDER BY studentname, classname, sectionname';
