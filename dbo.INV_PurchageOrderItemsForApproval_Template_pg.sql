CREATE OR REPLACE FUNCTION "dbo"."INV_PurchageOrderItemsForApproval_Template"(
    "User_Id" bigint,
    "INVMPO_Id" bigint
)
RETURNS TABLE(
...
BEGIN
    ...
    IF("SanctionLevelNo"=1) THEN
        ...
        SELECT DISTINCT "IMP"."INVMPO_Id", "ITP"."INVMPI_Id", "ITP"."INVMI_Id", "IMI"."INVMI_ItemName", 
               ...
               "INVTPO_Amount", "INVTPO_TaxAmount", "INVTPO_POQty", "INVTPO_POQty" AS "INVTPO_ApproveQty", 
               ''::text AS "INVTPO_Remarks", "INVTPO_RatePerUnit", "ITP"."INVTPO_Id",
               NULL::boolean AS "INVTPOAPP_RejectFlg"
        ...
        WHERE "ITP"."INVMPO_Id"="INVMPO_Id" AND "INVTPO_ActiveFlg"=1 
          AND ("INVTPO_RejectFlg" IS NULL OR "INVTPO_RejectFlg"=false)
    ...
    ELSE
        IF("SanctionLevelNo"<>1) THEN
            ...
            RETURN QUERY
            SELECT DISTINCT "POA"."INVMPO_Id", "INVMPI_Id", "TPOA"."INVMI_Id", "INVMI_ItemName", 
                   "TPOA"."INVMUOM_Id", "INVMUOM_UOMName",
                   "INVTPOAPP_Amount" AS "INVTPO_Amount", "INVTPOAPP_TaxAmount" AS "INVTPO_TaxAmount",
                   "INVTPOAPP_POQty" AS "INVTPO_POQty", "INVTPOAPP_ApprovedQty" AS "INVTPO_ApproveQty", 
                   ''::text AS "INVTPO_Remarks", "INVTPOAPP_RatePerUnit" AS "INVTPO_RatePerUnit", 
                   "TPOA"."INVTPO_Id",
            ...
            WHERE ("POA"."INVMPOAPP_RejectFlg"=false) 
