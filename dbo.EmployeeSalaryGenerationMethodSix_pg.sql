CREATE OR REPLACE FUNCTION "dbo"."EmployeeSalaryGenerationMethodSix"(
    p_HRME_ID BIGINT,
    p_MI_ID BIGINT,
    p_HRMLY_ID BIGINT,
...
BEGIN
    ...
    ELSE
        ...
        RAISE NOTICE 'ID %', v_NEW_IDENTITY;
    END IF;

    FOR v_HRMED_IdCUR1, v_HREED_AmountCUR1, v_HRMED_EDTypeFlagCUR1, v_HRMED_EarnDedFlagCUR1, v_HRMED_AmountPercentFlagCUR1, v_HRMED_RoundOffFlagCUR1 IN
    ...
    FOR v_HRMEDP_HRMED_IdCUR2 IN
        SELECT A."HRMED_Id"
        FROM "HR_Master_EarningsDeductions" A
        LEFT JOIN "HR_Employee_EarningsDeductions" B ON B."HRMED_Id" = A."HRMED_Id"
        WHERE A."MI_Id" = p_MI_ID AND B."HRME_Id" = p_HRME_ID AND B."HREED_ActiveFlag" = 1 AND A."HRMED_ActiveFlag" = 1 AND
    ...
    LOOP
        ...
        IF v_TEMPSALCOUNT = 0 THEN
            FOR v_HRMED_IdCUR3, v_HRMEDP_HRMED_IdCUR3, v_hrmed_amount, v_HREED_PercentageCUR3, v_HRMED_EDTypeFlagCUR3, v_HRMED