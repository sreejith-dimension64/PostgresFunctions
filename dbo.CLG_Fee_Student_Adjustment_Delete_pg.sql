CREATE OR REPLACE FUNCTION "dbo"."CLG_Fee_Student_Adjustment_Delete"(
    "@FCSA_ID" bigint
)
RETURNS void
LANGUAGE plpgsql
...
BEGIN
    ...
    WHERE "FCSA_Id" = "@FCSA_ID";

    UPDATE "CLG"."Fee_College_Student_Status" 
    SET "FCSS_RunningExcessAmount" = ("FCSS_RunningExcessAmount" + "@adjusteamount"),
        "FCSS_ExcessAmountAdjusted" = ("FCSS_ExcessAmountAdjusted" - "@adjusteamount")
    WHERE "MI_Id" = "@miid" 
    ...
    UPDATE "CLG"."Fee_College_Student_Status" 
    SET "FCSS_ToBePaid" = ("FCSS_ToBePaid" + "@adjusteamount"),
        "FCSS_AdjustedAmount" = ("FCSS_AdjustedAmount" - "@adjusteamount")
    WHERE "MI_Id" = "@miid" 
      AND "ASMAY_Id" = "@asmayid" 
      AND "AMCST_Id" = "@amstid" 
    ...
    DELETE FROM "CLG"."Fee_College_Student_Adjustment" 
    WHERE "FCSA_Id" = "@FCSA_ID";
