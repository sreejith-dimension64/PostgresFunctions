CREATE OR REPLACE FUNCTION "dbo"."Fee_Tuition_Fee_Certificate"(
    "yearId" TEXT,
    "classid" TEXT,
    "sectionid" TEXT,
    "studid" TEXT,
...
BEGIN
    ...
    WHERE "Adm_School_Y_Student"."AMST_Id" = "Fee_Tuition_Fee_Certificate"."studid"::BIGINT
        AND "Adm_School_M_Academic_Year"."ASMAY_Id" = "Fee_Tuition_Fee_Certificate"."yearId"::BIGINT
        AND "Adm_M_Student"."MI_Id" = "Fee_Tuition_Fee_Certificate"."mi_id"::BIGINT;
