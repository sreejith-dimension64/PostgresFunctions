CREATE OR REPLACE FUNCTION "dbo"."Export_from_preadmission_to_admission"(
    p_PASR_Id bigint,
    p_ASMAY_Id bigint,
    p_MI_Id bigint
)
...
BEGIN
    ...
    BEGIN
        ...
        IF (v_pasrcount = 0) THEN
            ...
            INSERT INTO "Adm_M_Student" (
                "MI_Id","ASMAY_Id","AMST_FirstName","AMST_MiddleName","AMST_LastName","AMST_Date","AMST_Sex","AMST_DOB","PASR_Age","ASMCL_Id","AMST_BloodGroup","AMST_MotherTongue","AMST_PerStreet","AMST_PerArea","AMST_PerCity","AMST_PerState","AMST_PerCountry","AMST_PerPincode","AMST_ConStreet","AMST_ConArea","AMST_ConCity","AMST_ConState","AMST_ConCountry","AMST_ConPincode","AMST_AadharNo","AMST_MobileNo","AMST_emailId","AMST_FatherAliveFlag","AMST_FatherName","AMST_FatherAadharNo","AMST_FatherSurname","AMST_FatherEducation","AMST_FatherOccupation","AMST_FatherDesignation","AMST_FatherMonIncome","AMST_FatherMobleNo","AMST_FatheremailId","AMST_MotherAliveFlag","AMST_MotherName","AMST_MotherAadharNo","AMST_MotherSurname","AMST_MotherEducation","AMST_MotherOccupation","AMST_MotherDesignation","AMST_MotherMonIncome","AMST_MotherMobileNo","AMST_MotherEmailId","AMST_TotalIncome","AMST_BirthPlace","AMST_Nationality","AMST_HostelReqdFlag","AMST_TransportReqdFlag","AMST_GymReqdFlag","AMST_ECSFlag","AMST_PaymentFlag","AMST_AmountPaid","AMST_PaymentType","AMST_PaymentDate","AMST_ReceiptNo","AMST_ActiveFlag","AMST_ApplStatus","AMST_FinalpaymentFlag","AMST_FatherOfficeAdd","AMST_FatherNationality","AMST_MotherNationality","AMST_BirthCertNO","AMST_PerAdd3","AMST_MotherOfficeAdd","AMST_SOL","AMST_Concession_Type","IVRMMR_Id","IMCC_Id","IC_Id","AMST_Noofsisters","AMST_Noofbrothers","AMC_Id","AMST_Photoname","AMST_DOB_Words","AMST_LanguageSpoken","CreatedDate","UpdatedDate","ANST_FatherPhoto","ANST_MotherPhoto","ASMST_Id"
            )     
            SELECT "MI_Id",p_ASMAY_Id,"PASR_FirstName","PASR_MiddleName","PASR_LastName",CURRENT_TIMESTAMP,"PASR_Sex","PASR_DOB","PASR_Age","ASMCL_Id","PASR_BloodGroup","PASR_MotherTongue","PASR_PerStreet","PASR_PerArea","PASR_PerCity","PASR_PerState","PASR_PerCountry","PASR_PerPincode","PASR_ConStreet","PASR_ConArea","PASR_ConCity","PASR_ConState","PASR_ConCountry","PASR_ConPincode","PASR_AadharNo","PASR_MobileNo","PASR_emailId","PASR_FatherAliveFlag","PASR_FatherName","PASR_FatherAadharNo","PASR_FatherSurname","PASR_FatherEducation","PASR_FatherOccupation","PASR_FatherDesignation","PASR_FatherIncome","PASR_FatherMobleNo","PASR_FatheremailId","PASR_MotherAliveFlag","PASR_MotherName","PASR_MotherAadharNo","PASR_MotherSurname","PASR_MotherEducation","PASR_MotherOccupation","PASR_MotherDesignation","PASR_MotherIncome","PASR_MotherMobleNo","PASR_MotheremailId","PASR_TotalIncome","PASR_BirthPlace","PASR_Nationality","PASR_HostelReqdFlag","PASR_TransportReqdFlag","PASR_GymReqdFlag","PASR_ECSFlag","PASR_PaymentFlag","PASR_AmountPaid","PASR_PaymentType","PASR_PaymentDate","PASR_ReceiptNo",v_activeflag,"PASR_ApplStatus","PASR_FinalpaymentFlag","PASR_FatherOfficeAddr","PASR_FatherNationality","PASR_MotherNationality","PASR_BirthCertificateNo","PASR_OtherPermanentAddr","PASR_MotherOfficeAddr",v_studentstatus,v_concesseion,"Religion_Id","CasteCategory_Id","Caste_Id","PASR_Noofbrothers","PASR_Noofsisters",v_AMC_Id,"PASR_Student_Pic_Path","PASR_DOBwords","PASR_MotherTongue",CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,"PASR_FatherPhoto","PASR_MotherPhoto","ASMST_Id"
            ...
            INSERT INTO "Adm_Master_Student_PA"("AMST_Id","PASR_Id","CreatedDate","UpdatedDate") 
            ...
            PERFORM "Auto_Fee_Group_mapping"(p_MI_Id, p_ASMAY_Id, v_MaxAmst_Id, v_userid);
            ...
            PERFORM "StudentDetails"(v_MaxAmst_Id, p_PASR_Id, p_MI_Id);
    ...
    PERFORM "Admission_Generate_Tpin"(p_MI_Id, v_MaxAmst_Id);
