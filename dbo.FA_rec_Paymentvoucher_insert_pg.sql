CREATE OR REPLACE FUNCTION "dbo"."FA_rec_Paymentvoucher_insert"(
    p_MI_Id bigint,
    p_FAMCOMP_Id bigint,
    p_IMFY_Id bigint,
    p_CFAMLED_Id bigint,
...
BEGIN
    ...
    VALUES(p_MI_Id,p_FAMCOMP_Id,p_IMFY_Id,'PaymentVoucher','',p_date,p_remarks,'','','','PaymentVoucher','',0,p_r_no,1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
    ...
    IF p_BoolBank = false THEN
        ...
        VALUES (p_FAMVOU_Id,p_DFAMLED_Id,p_amount,'Dr','',NULL,'','','','',0,'',1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);

        INSERT INTO "FA_T_Voucher"("FAMVOU_Id","FAMLED_Id","FATVOU_Amount","FATVOU_CRDRFlg","FATVOU_TransactionTypeFlg","FATVOU_Narration","FATVOU_ChequNo","FATVOU_ChequeDate","FATVOU_BankName","FATVOU_ReferrenceNo","FATVOU_BillwiseFlg","FATVOU_Description","FATVOU_ActiveFlg","FATVOU_CreatedDate","FATVOU_UpdatedDate")
        VALUES (p_FAMVOU_Id,p_CFAMLED_Id,p_amount,'Cr','',NULL,'','','','',0,'',1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
