CREATE OR REPLACE FUNCTION "dbo"."ISM_DeviationReport_Calculation_send_mail_proc"(
    "MI_Id" VARCHAR,
    "HRME_Id" TEXT,
    "StartDate" TIMESTAMP,
    "EndDate" TIMESTAMP,
...
BEGIN
    ...
    IF "Flag" = '1' THEN
        "Slqdymaic" := '
SELECT "ITP"."HRME_EmailId", "ITP"."ISMTPL_Id", "ITP"."HRME_Id", "ITP"."ISMTPL_PlannerName",
...
CAST((SUM("ITPT"."ISMTPLTA_EffortInHrs"))*100/("ITP"."ISMTPL_TotalHrs") AS NUMERIC(18,2)) AS "Completed_Percentage",
(CASE WHEN CAST((100-(SUM("ITPT"."ISMTPLTA_EffortInHrs"))*100/("ITP"."ISMTPL_TotalHrs")) AS NUMERIC(18,2))>0 THEN
CAST((100-(SUM("ITPT"."ISMTPLTA_EffortInHrs"))*100/("ITP"."ISMTPL_TotalHrs")) AS NUMERIC(18,2)) ELSE 0 END) AS "Deviation_Percentage"
...
WHERE ' || "betweendates" || ' AND "ITP"."HRME_Id" IN (' || "HRME_Id" || ') AND "ITPT"."ISMTPLTA_Status"=''Completed''
