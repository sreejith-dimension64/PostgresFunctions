CREATE OR REPLACE FUNCTION "dbo"."Exam_Portal_BGHS_Student_SubjectWise_Details_Promotion"(
    "@MI_Id" TEXT,
    "@ASMAY_Id" TEXT,
    "@ASMCL_Id" TEXT,
    "@ASMS_Id" TEXT,
...
RETURNS TABLE(
    ...
    "EYCES_MarksDisplayFlg" INTEGER,
    "EYCES_GradeDisplayFlg" INTEGER,
    "WORKINGDAYS" BIGINT,
    "PRESENTDAYS" BIGINT
)
LANGUAGE plpgsql
...
BEGIN
    IF "@FLAG" = '1' THEN
        ...
        INNER JOIN "EXM"."Exm_Yearly_Category" "J" ON "J"."ASMAY_Id" = "E"."ASMAY_Id" AND "J"."EMCA_Id" = "I"."EMCA_Id" 
            AND "J"."ASMAY_Id"::TEXT = "@ASMAY_Id" AND "J"."EYC_ActiveFlg" = 1
        ...
        WHERE "C"."ASMAY_Id"::TEXT = "@ASMAY_Id" AND "A"."ASMAY_Id"::TEXT = "@ASMAY_Id"
            AND "A"."ASMCL_Id"::TEXT = "@ASMCL_Id" AND "C"."ASMCL_Id"::TEXT = "@ASMCL_Id" 
            AND "A"."ASMS_Id"::TEXT = "@ASMS_Id" AND "C"."ASMS_Id"::TEXT = "@ASMS_Id"
            AND "A"."ESTSU_ActiveFlg" = 1 AND "B"."ISMS_ActiveFlag" = 1 
            AND "A"."AMST_Id"::TEXT = "@AMST_Id" AND "C"."AMST_Id"::TEXT = "@AMST_Id" 
    ...
    ELSIF "@FLAG" = '2' THEN
        ...
        SELECT 
            ...
            NULL::INTEGER AS "EYCES_MarksDisplayFlg",
            NULL::INTEGER AS "EYCES_GradeDisplayFlg",
        ...
        WHERE "A"."MI_Id"::TEXT = "@MI_Id" AND "A"."ASMAY_Id"::TEXT = "@ASMAY_Id" 
            AND "A"."ASMCL_Id"::TEXT = "@ASMCL_Id" AND "A"."ASMS_Id"::TEXT = "@ASMS_Id"
            AND "C"."ASMAY_Id"::TEXT = "@ASMAY_Id" AND "C"."ASMCL_Id"::TEXT = "@ASMCL_Id" AND "C"."ASMS_Id"::TEXT = "@ASMS_Id" 
            AND "A"."ASA_Activeflag" = 1
            AND "B"."AMST_Id"::TEXT = "@AMST_Id"
        GROUP BY "B"."AMST_Id";
    ...
    ELSIF "@FLAG" = '3' THEN
        ...
        INNER JOIN "EXM"."Exm_Yearly_Category" "J" ON "J"."ASMAY_Id" = "E"."ASMAY_Id" AND "J"."EMCA_Id" = "I"."EMCA_Id" 
            AND "J"."ASMAY_Id"::TEXT = "@ASMAY_Id" AND "J"."EYC_ActiveFlg" = 1
        INNER JOIN "EXM"."Exm_M_Promotion" "K" ON "K"."EYC_Id" = "J"."EYC_Id" AND "K"."EMP_ActiveFlag" = 1 
            AND "K"."MI_Id"::TEXT = "@MI_Id"
