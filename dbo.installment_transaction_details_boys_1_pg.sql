CREATE OR REPLACE FUNCTION "dbo"."installment_transaction_details_boys_1"(
    "MI_Id" TEXT,
    "ASMAY_Id" TEXT,
    "Amst_id" TEXT,
    "fyp_id" TEXT
...
BEGIN
    ...
    INNER JOIN "Fee_Student_Status" ON "Adm_School_Y_Student"."AMST_Id" = "Fee_Student_Status"."AMST_Id"
    INNER JOIN "Fee_Y_Payment_School_Student" ON "Fee_Student_Status"."AMST_Id" = "Fee_Y_Payment_School_Student"."AMST_Id"
