CREATE OR REPLACE FUNCTION "dbo"."Chairman_yearwise_salary_New"(
    "@MI_ID" INT,
    "@year" VARCHAR(50)
)
RETURNS TABLE(
...
BEGIN
    ...
    SELECT 
        ...
        "New"."Deduction",
        "New"."Earning",
        "New"."Earning" - "New"."Deduction" AS "netamount"
    FROM (
        SELECT 
            "PVT_Source"."HRES_Month",
            "PVT_Source"."IVRM_Month_Id",
            SUM(CASE WHEN "PVT_Source"."HRMED_EarnDedFlag" = 'Deduction' THEN "PVT_Source"."Amt" ELSE 0 END) AS "Deduction",
            SUM(CASE WHEN "PVT_Source"."HRMED_EarnDedFlag" = 'Earning' THEN "PVT_Source"."Amt" ELSE 0 END) AS "Earning"
        FROM (
            SELECT DISTINCT 
            ...
            INNER JOIN "HR_Master_GroupType" "GT" ON "GT"."HRMGT_Id" = "E"."HRMGT_Id" 
                AND "GT"."MI_Id" = "@MI_ID"
            INNER JOIN "HR_Employee_Salary" "ES" ON "ES"."MI_Id" = "@MI_ID" 
        ...
        GROUP BY "PVT_Source"."HRES_Month", "PVT_Source"."IVRM_Month_Id"
    ) AS "New"
    ORDER BY "New"."IVRM_Month_Id"
    LIMIT 100;
END;
$$;