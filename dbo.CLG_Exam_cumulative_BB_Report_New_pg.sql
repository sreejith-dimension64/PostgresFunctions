CREATE OR REPLACE FUNCTION "dbo"."CLG_Exam_cumulative_BB_Report_New"(
    p_AMCO_Id bigint,
    p_AMB_Id bigint,
    p_ACSS_Id bigint,
    p_MI_Id bigint,
...
RETURNS TABLE(
    ...
    "AMST_DOB" timestamp,
    "AMAY_RollNo" bigint,
    "AMST_AdmNo123" character varying,
...
BEGIN
    ...
    GROUP BY "AMCS"."AMCST_Id","AMCS"."AMCST_FirstName","AMCS"."AMCST_MiddleName","AMCS"."AMCST_LastName","AMCS"."AMCST_DOB","ACYS"."ACYST_RollNo","AMCS"."AMCST_AdmNo","AMCS"."AMCST_RegistrationNo","CEYCES"."ISMS_Id","IMS"."ISMS_SubjectName","IMS"."ISMS_SubjectCode","CEYCES"."ECYSES_AplResultFlg","CEYCES"."ECYSES_MaxMarks","CEYCES"."ECYSES_MinMarks","CEYCES"."EMGR_Id","ECSMPS"."ECSTMPS_MaxMarks","ECSMPS"."ECSTMPS_SemAverage","ECSMPS"."ECSTMPS_SectionAverage","ECSMPS"."ECSTMPS_SemHighest","ECSMPS"."ECSTMPS_SectionHighest","ECSMPS"."ECSTMPS_ObtainedMarks","ECSMPS"."ECSTMPS_ObtainedGrade","ECSMPS"."ECSTMPS_PassFailFlg","EME"."EME_ExamName","AMC"."AMCO_CourseName","AMB_BranchName","AMSE_SEMName","ACMS_SectionName","EMGD1"."EMGD_Remarks","ECSMP"."ECSTMP_TotalObtMarks","ECSTMP_TotalMaxMarks","ECSMP"."ECSTMP_Percentage","ECSMP"."ECSTMP_TotalGrade","ECSMP"."ECSTMP_SemRank","ECSMP"."ECSTMP_SectionRank","EMGD2"."EMGD_Remarks","ECSMP"."ECSTMP_TotalObtMarks","MI"."MI_name","CEYCES"."ECYSES_SubjectOrder","CEYCE"."ECYSE_AttendanceFromDate","CEYCE"."ECYSE_AttendanceToDate","ECSMP"."ECSTMP_Result"
