CREATE OR REPLACE FUNCTION "dbo"."Exam_cumulative_BB_Report_Modify_BKP"(
    p_ASMAY_Id TEXT,
    p_ASMCL_Id TEXT,
    p_ASMS_Id TEXT,
    p_MI_Id TEXT,
...
BEGIN
    ...
    INNER JOIN "Adm_School_Y_Student" AS h ON h."AMST_Id" = f."AMST_Id" AND h."ASMAY_Id" = ' || p_ASMAY_Id || ' AND h."ASMCL_Id" = ' || p_ASMCL_Id || '
    AND h."ASMS_Id" = ' || p_ASMS_Id || ' AND h."AMST_Id" IN (' || p_AMST_Id || ')
    ...
    AND a."ASMCL_Id" = ' || p_ASMCL_Id || ' AND a."ASMS_Id" = ' || p_ASMS_Id || ' AND a."ASMAY_Id" = ' || p_ASMAY_Id || ' AND a."MI_Id" = ' || p_MI_Id || '
    AND a."EME_Id" = ' || p_EME_Id || ' AND a."AMST_Id" IN (' || p_AMST_Id || ')
